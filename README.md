...
**~72% overall.** Everything software-only is done and tested (276/276
...
onto an untracked object's distance) - see M10. Every remaining item below
needs hands-on-hardware work that hasn't happened yet - nothing on the
critical path is blocked on more code:
...
Test suite: `.venv/Scripts/python -m pytest -q` → 276 passed. Android: real
