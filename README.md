...
**~70% overall.** Everything software-only is done and tested (249/249
...
running, not just in isolation. Every remaining item below needs
hands-on-hardware work that hasn't happened yet - nothing is blocked on
more code:
