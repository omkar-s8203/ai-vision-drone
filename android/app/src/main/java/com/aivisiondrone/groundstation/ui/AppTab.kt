 ...
 * view, direct FC control, AI guidance modes, a full MAVLink status
 * dashboard, and app/connection settings - each its own tab rather than
 * one crowded screen. */
enum class AppTab(val label: String, val icon: ImageVector) {
    FLY("Fly", Icons.Filled.Videocam),
    CONTROL("Control", Icons.Filled.FlightTakeoff),
    AI("AI Modes", Icons.Filled.SmartToy),
    STATUS("Status", Icons.Filled.Analytics),
