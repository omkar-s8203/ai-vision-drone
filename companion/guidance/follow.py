...
class FollowController:
    """Computes a velocity setpoint to hold a configured separation from the
    tracked target and keep it centered in frame. Never touches MAVLink -
    output is a GuidanceCommand for the Safety Supervisor to gate.
    """
